...
const History1 = () => {
    return (
        <View>
            ...
            <Text style={{ width: 77, height: 24, top: 60, left: 73, fontSize: 19, fontWeight: '400', color: '#6D3805' }}>Ongoing</Text>
            <Text style={{ width: 67, height: 24, top: 35, left: 250, color: '#FF5E00', fontWeight: '400', fontSize: 19 }}>History</Text>
            <View style={{left:-7}}>
                <View style={{width:50,height:50,backgroundColor:'#F37A20',top:80,left:40,borderRadius:30}}>
            ...
            <View style={{left:-7,top:130}}>
                <View style={{width:50,height:50,backgroundColor:'#F37A20',top:70,left:40,borderRadius:30}}>
                    <Image style={{width:27,height:27,top:9,left:13}} source={require('../../../../../../image/mumu.png')}></Image>
